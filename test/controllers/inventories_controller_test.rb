...
class InventoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inventory" do
    assert_difference("Inventory.count") do
      post inventories_url, params: { inventory: { item_id: @inventory.item_id, price: @inventory.price, user_id: @inventory.user_id } }
    end
  ...
  test "should update inventory" do
    patch inventory_url(@inventory), params: { inventory: { item_id: @inventory.item_id, price: @inventory.price, user_id: @inventory.user_id } }
